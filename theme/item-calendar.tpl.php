...
$index = 0;
?>
 <?php if ($view->query->pager->display->handler->options['path'] == 'calendario-consejero/diario'): ?>
...
<?php if ($view->query->pager->display->handler->options['path'] == 'calendario-consejero/semanal'): ?>
...
<?php endif; ?>
 ...
 <?php if ($view->query->pager->display->handler->options['path'] == 'calendario-consejero/mes'):?>
    <div class="<?php print !empty($item->class) ? $item->class : 'item'; ?>">
      <div class="view-item view-item-<?php print $view->name ?>">
...
<?php endif; ?> 
 ...
 <?php if ($view->query->pager->display->handler->options['path'] == 'calendario-estudiante/%/diario'): ?>
  
  <?php if(!empty($item->row->field_collection_item_field_data_field_citas_agenda_item_id)):  ?>
    <?php $class = 'my-quotes'; ?>
  <?php endif; ?> 
  ...
  <?php endif; ?> 
    ...
    <div class="<?php print !empty($item->class) ? $item->class : 'item'; ?>">
      <div class="view-item <?php print($class) ?> view-item-<?php print $view->name ?>">
      <div class="calendar <?php print $item->granularity; ?>view">
        <?php print theme('calendar_stripe_stripe', array('item' => $item)); ?>
        <div class="<?php print $item->date_id ?> contents">
          <?php foreach ($rendered_fields as $field):?>
 ...
 <?php if ($view->query->pager->display->handler->options['path'] == 'calendario-estudiante/%/semanal'): ?>
    <div class="<?php print !empty($item->class) ? $item->class : 'item'; ?>">
      <div class="view-item view-item-<?php print $view->name ?>">
      <div class="calendar <?php print $item->granularity; ?>view">
        <?php print theme('calendar_stripe_stripe', array('item' => $item)); ?>
